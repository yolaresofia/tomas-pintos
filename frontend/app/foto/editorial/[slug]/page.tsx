...
export async function generateStaticParams() {
  ...
  return (data || [])
    .filter((p: { slug: string | null; category: string | null }) => p.category === "foto-editorial")
...
export default async function FotoEditorialPage(props: Props) {
  const params = await props.params;
  ...
  if (!project?._id || project.category !== "foto-editorial") {
    return notFound();
  }
