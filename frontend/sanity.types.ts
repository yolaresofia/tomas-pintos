...
// Variable: aboutQuery
// Query: *[_type == "about" && _id == "about"][0]{    _id,    mainText,    selectedClients,    selectedClientsDescription,    press[]{      _key,      label,      linkType,      url,      email    },    contact[]{      _key,      label,      linkType,      url,      email    },    backgroundColor,    seoTitle,    seoDescription  }
